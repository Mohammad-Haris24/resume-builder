...
const Feature = () => {
  ...
  return (
     <div id='features' className='flex flex-col items-center scroll-mt-12 my-10'>

<div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 border border-green-200 rounded-full px-6 py-1.5 w-48">
            <Zap width={14} />
            <span>Simple Process</span>
        </div>

        <Title title="Build your Resume" description="Our streamlined process helps you create a professional resume in minutes with intelligent Al-powered tools and features." />
