   ...
   <>
            <div className="min-h-screen pb-20">
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <p className="max-w-md text-center text-base my-7">Create, edit and download resumes with AI-powered assistance.</p>
...
import { Auth } from './../../../../server/node_modules/mongodb/src/mongo_client';
